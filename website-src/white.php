...
<html lang="en">
  ...
  <div class="container">
    ...
    $result = mysqli_query($con,"SELECT * FROM fboswell3 WHERE rank = 'White' and checkedin = 'Yes'");
    $i = 0;
    ...
    $result = mysqli_query($con,"SELECT * FROM fboswell3 WHERE rank = 'White' and checkedin = 'No'");
